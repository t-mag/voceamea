...
- (int) restrictedDimensionBlockSize {
    ...
    int size;
    if (isVert) {
        size=round(self.collectionView.frame.size.width / self.blockPixels.width);
    }
    else{
        size=round(self.collectionView.frame.size.height / self.blockPixels.height);
    }
    
    
   // int size = isVert? round(self.collectionView.frame.size.width / self.blockPixels.width) : round(self.collectionView.frame.size.height / self.blockPixels.height);
