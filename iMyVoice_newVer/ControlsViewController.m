...
{
   // [self.delegate dismissPopover:@"DISMISSED"];
}
...
//    self.cutCopyPasteSection = [self addCutCopyPaste];
    self.buttonSection = [self addButtons];

//    self.buttonSection = [self addButton_FromList];
//     self.buttonSection = [self addButton_FromCamera];
//     self.buttonSection = [self addButton_FromGallery];
//     self.buttonSection = [self addButton_FromWeb];
//     self.buttonSection = [self addButton_RemoveSymbol];
...
- (RETableViewSection *)addBasicControls
{
    ...
    self.segmentItem2 = [RESegmentedItem itemWithTitle:nil segmentedControlImages:@[[UIImage imageNamed:@"snd_icon"], [UIImage imageNamed:@"pic_icon"]] value:0 switchValueChangeHandler:^(RESegmentedItem *item) {
        NSLog(@"Value: %li", (long)item.value);
    }];
...
- (RETableViewSection *)addButtons
{
    RETableViewSection *section = [RETableViewSection section];
    [self.manager addSection:section];
    
    [section addItem:[RETableViewItem itemWithTitle:@"Add from list" accessoryType:UITableViewCellStyleDefault selectionHandler:^(RETableViewItem *item) {
        [item deselectRowAnimated:YES];
        
    }]];
//    [section addItem:[RETableViewItem itemWithTitle:@"Add from camera" accessoryType:UITableViewCellStyleDefault selectionHandler:^(RETableViewItem *item) {
////        Camera_viewcontroller* cameraVC = [[Camera_viewcontroller alloc]initWithNibName:@"Camera_viewcontroller" bundle:nil];
////        [self.navigationController presentViewController:cameraVC animated:YES completion:^(void){
//        
//             [item deselectRowAnimated:YES];
//                   
//        }];
...
//    }]];
    [section addItem:[RETableViewItem itemWithTitle:@"Add from gallery" accessoryType:UITableViewCellStyleDefault selectionHandler:^(RETableViewItem *item) {
        [item deselectRowAnimated:YES];
    }]];
    [section addItem:[RETableViewItem itemWithTitle:@"Add from web" accessoryType:UITableViewCellStyleDefault selectionHandler:^(RETableViewItem *item) {
        [item deselectRowAnimated:YES];
    }]];

    
//    
//    RETableViewItem *buttonItem = [RETableViewItem itemWithTitle:@"Add from list" accessoryType:UITableViewCellAccessoryNone selectionHandler:^(RETableViewItem *item) {
//        item.title = @"Pressed!";
//        [item reloadRowWithAnimation:UITableViewRowAnimationAutomatic];
//    }];
...
- (RETableViewSection *)addButton_FromList
{
    RETableViewSection *section = [RETableViewSection section];
    [self.manager addSection:section];
...
- (RETableViewSection *)addButton_FromCamera
{
    RETableViewSection *section = [RETableViewSection section];
    [self.manager addSection:section];
    
    RETableViewItem *buttonItem = [RETableViewItem itemWithTitle:@"Add from camera" accessoryType:UITableViewCellAccessoryNone selectionHandler:^(RETableViewItem *item) {
        item.title = @"Pressed!";
        [item reloadRowWithAnimation:UITableViewRowAnimationAutomatic];
    }];
    buttonItem.textAlignment = NSTextAlignmentLeft;
...
- (RETableViewSection *)addButton_FromGallery
{
    RETableViewSection *section = [RETableViewSection section];
    [self.manager addSection:section];
    
    RETableViewItem *buttonItem = [RETableViewItem itemWithTitle:@"Add from gallery" accessoryType:UITableViewCellAccessoryNone selectionHandler:^(RETableViewItem *item) {
        item.title = @"Pressed!";
        [item reloadRowWithAnimation:UITableViewRowAnimationAutomatic];
    }];
    buttonItem.textAlignment = NSTextAlignmentLeft;
...
- (RETableViewSection *)addButton_FromWeb
{
    RETableViewSection *section = [RETableViewSection section];
    [self.manager addSection:section];
    
    RETableViewItem *buttonItem = [RETableViewItem itemWithTitle:@"Add from web" accessoryType:UITableViewCellAccessoryNone selectionHandler:^(RETableViewItem *item) {
        item.title = @"Pressed!";
        [item reloadRowWithAnimation:UITableViewRowAnimationAutomatic];
    }];
    buttonItem.textAlignment = NSTextAlignmentLeft;
...
- (RETableViewSection *)addButton_RemoveSymbol
{
    RETableViewSection *section = [RETableViewSection section];
    [self.manager addSection:section];
    
    RETableViewItem *buttonItem = [RETableViewItem itemWithTitle:@"Remove symbol" accessoryType:UITableViewCellAccessoryNone selectionHandler:^(RETableViewItem *item) {
        item.title = @"Pressed!";
        [item reloadRowWithAnimation:UITableViewRowAnimationAutomatic];
    }];
    buttonItem.textAlignment = NSTextAlignmentLeft;
